...
// struct train_controller_msg {
//   train_control_type tc;
//   int arg1;
//   int arg2;
// };
...
//   RegisterAs("trainctl");
//   tid_t uart_server = WhoIs("txuarts1");
//   char buffer[sizeof(train_controller_msg)];
//   train_controller_msg *msg = (train_controller_msg*)buffer;
//   tid_t request_tid;
//   const char* reply = "o";

//   while (1) {
//     int request = Receive((int*)&request_tid, buffer, sizeof(train_controller_msg));
//     if (request <= 0) continue;
//     switch (msg->tc) {
//       case train_control_type::TR: {
//         // set speed
//         DEBUG_LITERAL("Got speed cmd\r\n");
//         Putc(uart_server, 1, msg->arg2);
//         Putc(uart_server, 1, msg->arg1);
//         Reply(request_tid, reply, 1);
//         break;
//       }
//       case train_control_type::RV: {
//         // reverse
//         // Putc(uart_server, 1, )
//         Reply(request_tid, reply, 1);
//         break;
//       }
//       case train_control_type::SW: {
//         // solenoid
//         Reply(request_tid, reply, 1);
//         break;
//       }
//       case train_control_type::SS: {
//         // sensors
//         Reply(request_tid, reply, 1);
//         break;
//       }
...
//   tid_t train_ctrl = WhoIs("trainctl");
//   tid_t clock_server = WhoIs("clock_server");
...
//   train_controller_msg cmd_msg = { train_control_type::NONE, 0, 0 };
...
//           valid = true;
//           cmd_msg.tc = train_control_type::TR;
//           cmd_msg.arg1 = arg1;
//           cmd_msg.arg2 = arg2;
//           Send(train_ctrl, (char*)&cmd_msg, sizeof(train_controller_msg), &reply, 1);
//         }
//       } else if (troll::sscan(command_buffer + 1, curr_size - 1, "rv {}", arg1)) {
//         if (is_valid_train(arg1)) {
//           valid = true;
//           cmd_msg.tc = train_control_type::RV;
//           cmd_msg.arg1 = arg1;
//           Send(train_ctrl, (char*)&cmd_msg, sizeof(train_controller_msg), &reply, 1);
//         }
//       } else if (troll::sscan(command_buffer + 1, curr_size - 1, "sw {} {}", arg1, arg2)) {
//         if (is_valid_solenoid(arg1) && is_valid_solenoid_dir(arg2)) {
//           valid = true;
//           cmd_msg.tc = train_control_type::SW;
//           cmd_msg.arg1 = arg1;
//           cmd_msg.arg2 = arg2;
//           Send(train_ctrl, (char*)&cmd_msg, sizeof(train_controller_msg), &reply, 1);
//         }
...
//       if (!valid) {
//         Send(display_ctrl, "s Invalid!", 10, &reply, 1);
//       }
//       Send(display_ctrl, clear_line, 13, &reply, 1);
//       curr_size = 1;
...
void first_user_task() {
  ...
  // Create(PRIORITY_L1, nameserver);
  // tid_t cs = Create(PRIORITY_L1, clockserver);
  // Create(PRIORITY_L1, clocknotifier);
  ...
  // Create(PRIORITY_L1, [] { tx_uartserver(1); });
  // Create(PRIORITY_L1, [] { rx_uartserver(1); });

  // Create(PRIORITY_L1, train_controller);
