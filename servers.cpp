...
//   tid_t notifier ;
//   if (uart_channel == 0) {
//     notifier = Create(priority_t::PRIORITY_L1, tx_uartnotifier);
//   } else {
//     notifier = Create(priority_t::PRIORITY_L1, tx_uartnotifier);
//   }
//   tid_t request_tid;
...
//       case 'n': {
//         // notifier
//         if (buffer[1] == 1) { // tx interrupt

//         } else if (buffer[1] == 2) { // cts change
...
//           can_send = true;
//           if (!char_queue.empty()) {
//             DEBUG_LITERAL("Putting char\r\n");
//             c = char_queue.front();
//             char_queue.pop();
//             uart_write(0, uart_channel, c);
//             can_send = false; // need to wait for cts
//             Reply(notifier, reply, 1);
//           }
//         } else {
//           while (!char_queue.empty() && is_uart_writable(0, uart_channel)) {
//             c = char_queue.front();
//             char_queue.pop();
//             uart_write(0, uart_channel, c);
//           }
...
//         // if (uart_channel == 1) {
//         //   DEBUG_LITERAL("Got putc\r\n");
//         //   DEBUG_LITERAL("Length: ");
//         //   uart_putc(0, 0, char_queue.size() + '0');
//         //   DEBUG_LITERAL("\r\n");
//         //   DEBUG_LITERAL("Can send: ");
//         //   uart_putc(0, 0, can_send ? '1' : '0');
//         //   DEBUG_LITERAL("\r\n");
//         // }
...
//         char c;
//         if (uart_channel == 1) {
//           // if (can_send && is_uart_writable(0, uart_channel)) {
//           if (can_send && UartReadRegister(uart_channel, rpi::UART_TXLVL) != 0) {
//             // DEBUG_LITERAL("Putting char\r\n");
//             c = char_queue.front();
//             char_queue.pop();
//             // uart_write(0, uart_channel, c);
//             UartWriteRegister(uart_channel, rpi::UART_THR, c);
//             can_send = false; // need to wait for cts
//             Reply(notifier, reply, 1);
//           }
//         } else {
//           // while (!char_queue.empty() && is_uart_writable(0, uart_channel)) {
//           while (!char_queue.empty() && UartReadRegister(uart_channel, rpi::UART_TXLVL) != 0) {
...
//   tid_t notifier;
//   if (uart_channel == 0) {
//     notifier = Create(priority_t::PRIORITY_L1, rx_uartnotifier);
//   } else {
//     notifier = Create(priority_t::PRIORITY_L1, rx_uartnotifier);
//   }
//   tid_t request_tid;
...
//   etl::queue<tid_t, 512> requester_queue;
//   etl::queue<char, 512> char_queue;
...
//         while (UartReadRegister(uart_channel, rpi::UART_RXLVL) != 0) {
//           char_queue.push(UartReadRegister(uart_channel, rpi::UART_RHR));
